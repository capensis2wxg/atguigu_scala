...
class CompareComm2[T](obj1: T, obj2: T)(implicit ev$1: T => Ordered[T]) {
	def getter: T = if (obj1 > obj2) obj1 else obj2

	def getter2: T = if (obj1.compareTo(obj2) > 0) obj1 else obj2
}
